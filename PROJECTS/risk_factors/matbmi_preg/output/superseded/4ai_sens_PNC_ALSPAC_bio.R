...
MV_main1_c <- read_excel("//rdsfcifs.acrc.bris.ac.uk/MRC-IEU-research/projects/ieu2/p6/011/working/data/analysis/ALSPAC/results_files/Maternal and paternal BMI analysis.xls" , sheet = "Continuous Adjusted")
MV_main1_c$models <-"A Main analysis"
MV_main1_b <- read_excel("//rdsfcifs.acrc.bris.ac.uk/MRC-IEU-research/projects/ieu2/p6/011/working/data/analysis/ALSPAC/results_files/Maternal and paternal BMI analysis.xls" , sheet = "Binary Adjusted")
MV_main1_b$models <-"A Main analysis"

MV_main2_c <- read_excel("//rdsfcifs.acrc.bris.ac.uk/MRC-IEU-research/projects/ieu2/p6/011/working/data/analysis/ALSPAC/results_files/Maternal and paternal BMI analysis bio.xls" , sheet = "2 Maternal BMI CONTINUOUS")
MV_main2_c$models <-"B Main analysis, restricted to PNC sample"
MV_main2_b <- read_excel("//rdsfcifs.acrc.bris.ac.uk/MRC-IEU-research/projects/ieu2/p6/011/working/data/analysis/ALSPAC/results_files/Maternal and paternal BMI analysis bio.xls" , sheet = "2 Maternal BMI BINARY")
MV_main2_b$models <-"B Main analysis, restricted to PNC sample"

MV_main3_c <- read_excel("//rdsfcifs.acrc.bris.ac.uk/MRC-IEU-research/projects/ieu2/p6/011/working/data/analysis/ALSPAC/results_files/Maternal and paternal BMI analysis bio.xls" , sheet = "3 Maternal BMI CONTINUOUS")
MV_main3_c$models <-"C Main analysis, adjusted for paternal BMI"
MV_main3_b <- read_excel("//rdsfcifs.acrc.bris.ac.uk/MRC-IEU-research/projects/ieu2/p6/011/working/data/analysis/ALSPAC/results_files/Maternal and paternal BMI analysis bio.xls" , sheet = "3 Maternal BMI BINARY")
MV_main3_b$models <-"C Main analysis, adjusted for paternal BMI"

MV_main4_c <- read_excel("//rdsfcifs.acrc.bris.ac.uk/MRC-IEU-research/projects/ieu2/p6/011/working/data/analysis/ALSPAC/results_files/Maternal and paternal BMI analysis bio.xls" , sheet = "2 Paternal BMI CONTINUOUS")
MV_main4_c$models <-"D Paternal BMI, adjusted for maternal BMI"
MV_main4_b <- read_excel("//rdsfcifs.acrc.bris.ac.uk/MRC-IEU-research/projects/ieu2/p6/011/working/data/analysis/ALSPAC/results_files/Maternal and paternal BMI analysis bio.xls" , sheet = "2 Paternal BMI BINARY")
...
ggsave(paste0(out_dir, "forest_pnc_bin_allmod_suppfig_ALSPAC_bio.jpg"),  width = 15, height = 8)
...
ggsave(paste0(out_dir, "forest_pnc_cont_allmod_suppfig_ALSPAC_bio.jpg"),  width = 15, height = 8) 
