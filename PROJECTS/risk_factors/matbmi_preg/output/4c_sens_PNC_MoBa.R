...
MV_main1_c <- read_excel("./MOBA/results/Maternal and paternal BMI analysis.xls" , sheet = "Continuous Adjusted")
MV_main1_c$models <-"A Main analysis"
MV_main1_b <- read_excel("./MOBA/results/Maternal and paternal BMI analysis.xls" , sheet = "Binary Adjusted")
MV_main1_b$models <-"A Main analysis"

MV_main2_c <- read_excel("./MOBA/results/Maternal and paternal BMI analysis.xls" , sheet = "2 Maternal BMI CONTINUOUS")
MV_main2_c$models <-"B Main analysis, restricted to PNC sample"
MV_main2_b <- read_excel("./MOBA/results/Maternal and paternal BMI analysis.xls" , sheet = "2 Maternal BMI BINARY")
...
ggsave(paste0(out_dir, "forest_pnc_bin_allmod_suppfig_MOBA.jpg"),  width = 15, height = 8)
...
ggsave(paste0(out_dir, "forest_pnc_cont_allmod_suppfig_MOBA.jpg"),  width = 15, height = 8) 
